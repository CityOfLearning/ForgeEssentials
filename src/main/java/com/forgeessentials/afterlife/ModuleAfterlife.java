...
public class ModuleAfterlife extends ServerEventHandler {
	...
	public void onPlayerRespawn(PlayerEvent.PlayerRespawnEvent e) {
		...
		String potionEffects = APIRegistry.perms.getUserPermissionProperty(UserIdent.get(e.player),
		...
		Integer respawnHP = ServerUtil.tryParseInt(
				APIRegistry.perms.getUserPermissionProperty(UserIdent.get(e.player), ModuleAfterlife.PERM_HP));
		if (respawnHP != null) {
			e.player.setHealth(respawnHP);
		}

		Integer respawnFood = ServerUtil.tryParseInt(
				APIRegistry.perms.getUserPermissionProperty(UserIdent.get(e.player), ModuleAfterlife.PERM_FOOD));
		if (respawnFood != null) {
