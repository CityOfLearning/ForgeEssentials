...
public abstract class Zone {
	...
	public static final Comparator<Object> permissionComparator = (o1, o2) -> {
	...
	public boolean clearGroupPermission(String group, String permissionNode) {
		if (group != null) {
			PermissionList map = getGroupPermissions(group);
			if ((map != null) && !APIRegistry.getFEEventBus().post(
					new PermissionEvent.Group.ModifyPermission(getServerZone(), group, this, permissionNode, null))) {
	...
	public boolean clearPlayerPermission(UserIdent ident, String permissionNode) {
		if (ident != null) {
			PermissionList map = getPlayerPermissions(ident);
			if ((map != null) && !APIRegistry.getFEEventBus().post(
					new PermissionEvent.User.ModifyPermission(getServerZone(), ident, this, permissionNode, null))) {
				map.remove(permissionNode);
				return true;
			}
		}
	...
	/**
	 * List all permission nodes that have any kind of configuration in this
	 * zone
	 */
	...
	public boolean setGroupPermissionProperty(String group, String permissionNode, String value) {
		if ((group != null) && !APIRegistry.getFEEventBus().post(
				new PermissionEvent.Group.ModifyPermission(getServerZone(), group, this, permissionNode, value))) {
	...
	public boolean setPlayerPermissionProperty(UserIdent ident, String permissionNode, String value) {
		if ((ident != null) && !APIRegistry.getFEEventBus()
				.post(new PermissionEvent.User.ModifyPermission(getServerZone(), ident, this, permissionNode, value))) {
