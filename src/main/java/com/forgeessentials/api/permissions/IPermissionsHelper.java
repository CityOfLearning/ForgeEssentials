...
public interface IPermissionsHelper extends IPermissionProvider {
	 ...
	 *            underlying {@link IPermissionProvider} whether a player should
	 *            be allowed to access this permission by default, or as
	 *            operator only.
	 * @param description
	 ...
	 *            "permissionNode.$desc" permission-property.
	 */
