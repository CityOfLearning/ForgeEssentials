...
public class MultiworldManager extends ServerEventHandler implements NamedWorldHandler {
	...
	public void addWorld(Multiworld world) throws MultiworldException {
		...
		FMLLog.info("Adding World");
		loadWorld(world);
		FMLLog.info("Loading World");
		worlds.put(world.getName(), world);
		FMLLog.info("Saving World");
		world.save();
	}
	...
	protected void loadWorld(Multiworld world) throws MultiworldException {
		...
		try {
			...
			WorldServer worldServer = new WorldServerMultiworld(mcServer, savehandler, info, world.dimensionId, overworld,
					mcServer.theProfiler, world);
