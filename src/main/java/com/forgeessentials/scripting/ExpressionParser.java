...
public class ExpressionParser {
	...
	public static class Functions {
		...
		public static Function floor = new Function("floor",
				"Returns the largest integer less than or equal to it's input") {
		...
		public static Function ceil = new Function("ceil",
				"Returns the smallest integer greater than or equal to it's input") {
		...
		public static Function randf = new Function("randf",
	...
	public static Double computeExpression(String expr) {
		...
		while (m.matches()) {
			...
			if (t instanceof NumericToken) {
				if (functionArgs.isEmpty() || (functionArgs.peek() == null)
						|| (functionArgs.peek() < lastFunction.peek().numArgs())) {
					outputQueue.add(t);
				}
