...
public @interface At {
	...
	public enum Shift {
		 ...
		 * A value of 0 means that instructions are inserted directly before the
		 * injection point.
		 */
		BY,
	 ...
	 * For example use {@link At.Shift#AFTER AFTER} with an INVOKE
	 * InjectionPoint to move the returned opcodes to <i>after</i> the
	 * invoation. <br>
	 * <br>
