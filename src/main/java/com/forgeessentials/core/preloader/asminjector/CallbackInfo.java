...
/**
 * This dummy interface is used to generate return statements inside injectors.
 * <br>
 * Injectors <b>must never</b> call the wrong {@link CallbackInfo#doReturn()}
 * function or injection will fail.
 *
