...
public class ASMClassWriter extends ClassWriter {
	...
	protected String getCommonSuperClass(final String type1, final String type2) {
		...
		// However it is necessary for recalculating frames so there's nothing
		// else we can do
		...
		// catch (IOException e)
		// {
		// throw new RuntimeException(String.format("Error in
		// getCommonSuperClass(\"%s\", \"%s\"): ", type1, type2) + e.toString(),
		// e);
		// }
	}
