...
public class BlockPortalSize
{
    ...
    public BlockPortalSize(World worldIn, BlockPos p_i45694_2_, EnumFacing.Axis p_i45694_3_)
    {
        ...
        for (BlockPos blockpos1 = p_i45694_2_; p_i45694_2_.getY() > blockpos1.getY() - 21 && p_i45694_2_.getY() > 0
                && this.func_150857_a(worldIn.getBlockState(p_i45694_2_.offset(EnumFacing.DOWN)).getBlock()); p_i45694_2_ = p_i45694_2_.offset(EnumFacing.DOWN))
        {
            ;
        }
    ...
    protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
    {
        ...
        for (i = 0; i < 22; ++i)
        {
            ...
            if (!this.func_150857_a(this.field_150867_a.getBlockState(blockpos1).getBlock())
                    || this.field_150867_a.getBlockState(blockpos1.offset(EnumFacing.DOWN)).getBlock() != Blocks.obsidian)
            {
                break;
            }
        }
    ...
    protected int func_150858_a()
    {
        ...
        for (i = 0; i < this.field_150868_h; ++i)
        {
            if (this.field_150867_a.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).offset(EnumFacing.UP, this.field_150862_g)).getBlock() != Blocks.obsidian)
            {
    ...
    public void func_150859_c()
    {
        for (int i = 0; i < this.field_150868_h; ++i)
        {
            ...
            {
                this.field_150867_a.setBlockState(blockpos.offset(EnumFacing.UP, j),
