...
public class CommandMail extends ParserCommandBase {
	...
	public static void readMail(ICommandSender sender, Mail mail) {
		ChatOutputHandler.chatNotification(sender, Translator.format("Mail from %s on the %s",
				mail.sender.getUsernameOrUuid(), FEConfig.FORMAT_DATE_TIME.format(mail.timestamp)));
