...
public class ModuleProtection {
	...
	private static final Class<?>[] damageEntityClasses = new Class<?>[] {
			...
			// EntityMob
			EntityBlaze.class, EntityCreeper.class, EntityEnderman.class, EntityGiantZombie.class,
			EntitySilverfish.class, EntitySkeleton.class, EntitySpider.class, EntityWitch.class, EntityWither.class,
			EntityZombie.class, EntityPigZombie.class,
			// EntityGolem
	...
	public static EntityPlayer getCraftingPlayer(InventoryCrafting inventory) {
		Container abstractContainer = ReflectionHelper.getPrivateValue(InventoryCrafting.class, inventory,
	...
	public void registerPermissions(FEModuleServerInitEvent event) {
		...
		APIRegistry.perms.registerPermission(PERM_NEEDSFOOD, PermissionLevel.TRUE,
				"If denied to a player, their hunger bar will not deplete.");
		APIRegistry.perms.registerPermission(PERM_PVP, PermissionLevel.TRUE,
		...
		APIRegistry.perms.registerPermission(PERM_INTERACT_ENTITY, PermissionLevel.TRUE,
		...
		APIRegistry.perms.registerPermission(PERM_PRESSUREPLATE, PermissionLevel.TRUE,
		...
		APIRegistry.perms.registerPermission(PERM_DAMAGE_TO + Zone.ALL_PERMS, PermissionLevel.TRUE,
				"Allow damaging entities");
		APIRegistry.perms.registerPermission(PERM_DAMAGE_BY + Zone.ALL_PERMS, PermissionLevel.TRUE,
				"Allow getting hurt by entities");
		for (Class<?> entityClass : damageEntityClasses) {
			APIRegistry.perms.registerPermission(PERM_DAMAGE_TO + "." + entityClass.getSimpleName(),
					PermissionLevel.TRUE);
			APIRegistry.perms.registerPermission(PERM_DAMAGE_BY + "." + entityClass.getSimpleName(),
					PermissionLevel.TRUE);
		}
		...
		for (Item item : GameData.getItemRegistry().typeSafeIterable()) {
			if (!(item instanceof ItemBlock)) {
				...
				APIRegistry.perms.registerPermission(PERM_INVENTORY + itemPerm, PermissionLevel.TRUE,
						"INVENTORY " + itemName);
			}
		}
		...
		APIRegistry.perms.registerPermission(ZONE_KNOCKBACK, PermissionLevel.FALSE,
