...
public class CommandJScriptCommand extends ParserCommandBase {
	...
	public CommandJScriptCommand(ScriptInstance script, JsCommandOptions options, Object processCommand,
			Object tabComplete) {
	...
	public void parse(CommandParserArgs arguments) throws CommandException {
		try {
			if (arguments.isTabCompletion) {
				if (tabComplete != null) {
					script.getInvocable().invokeMethod(tabComplete, "call", processCommand,
							new JsCommandArgs(arguments));
				}
			} else {
				script.getInvocable().invokeMethod(processCommand, "call", processCommand,
						new JsCommandArgs(arguments));
			}
