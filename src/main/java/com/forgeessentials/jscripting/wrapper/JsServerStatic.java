...
public class JsServerStatic {
	...
	public void registerCommand(Object optionsObj, Object processCommand)// tsgen
																			// ignore
	{
		registerCommand(optionsObj, processCommand, null);
	}

	// methoddef registerCommand(options: CommandOptions, processCommand:
	// CommandCallback, tabComplete?: CommandCallback): void;
	public void registerCommand(Object optionsObj, Object processCommand, Object tabComplete)// tsgen
																								// ignore
	{
		// TODO: BIG HACK to get a readable object from an anonymous json
		// object!
		JsCommandOptions options = DataManager.getGson().fromJson(DataManager.getGson().toJson(optionsObj),
				JsCommandOptions.class);
	...
	public void runCommand(JsCommandSender sender, String cmd, Object... args) throws CommandException {
		...
		try {
			...
			// if (!ignoreErrors)
			// throw e;
			// LoggingHandler.felog.info(String.format("Silent script command
			// /%s %s failed: %s", cmd, StringUtils.join(args, " "),
			// e.getMessage()));
			e.printStackTrace();
			throw e;
		}
	...
	// methoddef setInterval(handler: (...args: any[]) => void, timeout?: any,
	// ...args: any[]): number;
	public int setInterval(Object fn, long timeout, Object... args) // tsgen
																	// ignore
	{
	...
	// methoddef setTimeout(handler: (...args: any[]) => void, timeout?: any,
	// ...args: any[]): number;
	public int setTimeout(Object fn, long timeout, Object... args) throws NoSuchMethodException, ScriptException // tsgen
																													// ignore
	{
		TimerTask task = new RunLaterTimerTask(new CallScriptMethodTask(script.getInvocable(), fn, fn, args));
