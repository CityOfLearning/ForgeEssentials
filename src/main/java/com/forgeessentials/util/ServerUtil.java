...
public abstract class ServerUtil {
	...
	/**
	 * Returns working directory or minecraft data-directory on client side.
	 * <br>
	...
	public static void replaceCommand(Class<CommandMessage> clazz, ICommand newCommand) {
		try {
			...
			Map<String, ICommand> commandMap = ReflectionHelper.getPrivateValue(CommandHandler.class, commandHandler,
					"commandMap", "a", "field_71562_a");
			Set<ICommand> commandSet = ReflectionHelper.getPrivateValue(CommandHandler.class, commandHandler,
