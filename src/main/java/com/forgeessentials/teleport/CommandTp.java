			...
			if ((args.length != 1) && (args.length != 2)) {
				if (args.length < (b0 + 3)) {
					...
					if (entity instanceof EntityPlayerMP) {
						...
						WarpPoint pos = new WarpPoint(entity.worldObj.provider.getDimensionId(), argX.func_179629_b(),
								argY.func_179629_b(), argZ.func_179629_b(), pitch, yaw);
						...
						entity.setLocationAndAngles(argX.func_179628_a(), argY.func_179628_a(), argZ.func_179628_a(),
								f2, pitch);
				...
				Entity targetEntity = getEntity(sender, args[args.length - 1], Entity.class);
