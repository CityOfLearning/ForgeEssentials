...
public class ModulePermissions extends ConfigLoaderBase {
	...
	private static void registerPermissions() {
		...
		APIRegistry.perms.registerPermission(FEPermissions.GROUP_PROMOTION, PermissionLevel.FALSE,
		...
		APIRegistry.perms.registerPermission(FEPermissions.SPAWN_BED, PermissionLevel.TRUE,
		...
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM, PermissionLevel.TRUE,
		...
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_USER, PermissionLevel.OP,
				"Allow basic access to users (displays infos)");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_USER_PERMS, PermissionLevel.OP,
				"Allow modifying user permissions");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_USER_SPAWN, PermissionLevel.OP,
				"Allow setting user spawn");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_USER_FIX, PermissionLevel.OP,
				"Allow setting user prefix / suffix");

		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_GROUP, PermissionLevel.OP,
				"Allow basic access to groups (displays infos)");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_GROUP_PERMS, PermissionLevel.OP,
				"Allow modifying group permissions");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_GROUP_SPAWN, PermissionLevel.OP,
				"Allow setting group spawn");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_GROUP_FIX, PermissionLevel.OP,
				"Allow setting group prefix / suffix");

		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_LIST_USERS, PermissionLevel.OP,
				"Allow listing users");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_LIST_GROUPS, PermissionLevel.OP,
				"Allow listing groups");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_LIST_ZONES, PermissionLevel.OP,
				"Allow listing zones");
		...
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_TEST, PermissionLevel.TRUE,
				"Allow testing permission nodes");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_RELOAD, PermissionLevel.OP,
				"Allow reloading changed permission files");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_SAVE, PermissionLevel.OP,
				"Allow force-saving permission files");
		APIRegistry.perms.registerPermission(PermissionCommandParser.PERM_DEBUG, PermissionLevel.TRUE,
