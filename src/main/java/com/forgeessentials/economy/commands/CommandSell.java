...
public class CommandSell extends ParserCommandBase {
	...
	public void parse(final CommandParserArgs arguments) throws CommandException {
		...
		QuestionerCallback handler = response -> {
			...
			if (removedAmount < amount) {
				removedAmount += ModuleEconomy.tryRemoveItems(arguments.senderPlayer, itemStack,
	...
	public void registerExtraPermissions() {
		APIRegistry.perms.registerPermission(getPermissionNode() + ".noconfirm", PermissionLevel.FALSE,
