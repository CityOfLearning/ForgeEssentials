...
public class CommandServerSettings extends ParserCommandBase {
	...
	public static List<String> options = Arrays.asList("allowFlight", "allowPVP", "buildLimit", "difficulty", "MotD",
			"spawnProtection", "gamemode");
		...
		case "motd":
			if (arguments.isEmpty()) {
				...
				server.getServerStatusResponse()
						.setServerDescription(new ChatComponentText(ChatOutputHandler.formatColors(motd)));
				server.setMOTD(motd);
