...
public class CommandButcherTickTask implements TickTask {
	...
	public static void schedule(ICommandSender sender, World world, String mobType, AxisAlignedBB aabb, int radius)
		...
		try {
			...
			throw new TranslatedCommandException("Unknown mob type. Mob types are "
	...
	public CommandButcherTickTask(ICommandSender sender, World world, ButcherMobType mobType, AxisAlignedBB aabb,
			int radius) {
		this.sender = sender;
