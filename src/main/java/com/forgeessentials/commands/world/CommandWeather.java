...
public class CommandWeather extends ParserCommandBase implements ConfigurableCommand {
	...
	public void parse(CommandParserArgs arguments) throws CommandException {
		...
		if (arguments.isEmpty()) {
			...
			arguments.confirm(Translator.format("%s is %s in world %d", StringUtils.capitalize(typeName),
					state.toString().toLowerCase(), dim));
			return;
		}
		...
		default:
			...
			save();
			arguments.confirm(Translator.format("%s %s in world %d",
