...
public class BiomeMap {
	...
	private BiomeMap(int idx, String id, double tmp, double rain, int waterColorMultiplier, int grassmult,
			int foliagemult) {
		/*
		...
		setTemperature(tmp);
		setRainfall(rain);
		watercolormult = waterColorMultiplier;
	...
	public void setRainfall(double rain) {
		...
		this.rain = rain;
		biomeindex256 = this.biomeLookup(256);
	}
