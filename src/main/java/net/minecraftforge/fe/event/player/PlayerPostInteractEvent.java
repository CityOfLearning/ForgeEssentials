...
public class PlayerPostInteractEvent extends PlayerEvent {
	...
	public PlayerPostInteractEvent(EntityPlayer player, World world, IBlockState block, BlockPos pos, EnumFacing side,
			float hitX, float hitY, float hitZ) {
		this(player, world, block, null, pos, side, hitX, hitY, hitZ);
	}

	protected PlayerPostInteractEvent(EntityPlayer player, World world, IBlockState block, ItemStack stack,
	...
	public PlayerPostInteractEvent(EntityPlayer player, World world, ItemStack stack, BlockPos pos, EnumFacing side,
			float hitX, float hitY, float hitZ) {
