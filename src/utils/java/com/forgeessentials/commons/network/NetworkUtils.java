...
public class NetworkUtils {
	...
	public static <REQ extends IMessage> void registerMessage(IMessageHandler<REQ, ?> messageHandler,
	...
	public static <REQ extends IMessage> void registerMessageProxy(Class<REQ> requestMessageType, int discriminator,
			Side side, NullMessageHandler<REQ> nmh) {
